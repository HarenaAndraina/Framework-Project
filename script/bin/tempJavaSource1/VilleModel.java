...
public class VilleModel {
    ...
    public VilleModel(int id, String nom) {
        this.id = id;
        this.nom = nom;
    }

    public VilleModel(String nom) {
        this.nom = nom;
    }

    public VilleModel getbyId(int id) throws Exception {
        ...
        try {
            ...
            query = "SELECT * FROM ville WHERE id = ?";
    ...
    public List<VilleModel> getAll() throws Exception {
