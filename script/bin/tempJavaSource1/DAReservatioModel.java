...
public class DAReservatioModel {
    private int id;
    ...
    public DAReservatioModel(Timestamp dateHeure, VolModel vol) {
        this.dateHeure = dateHeure;
        this.vol = vol;
    }
    public DAReservatioModel(int id, Timestamp dateHeure, VolModel vol) {
        this.id = id;
        this.dateHeure = dateHeure;
        this.vol = vol;
    }
    public DAReservatioModel() {
    }
    public void insert() throws Exception {
        ...
        try {
            ...
            // key
            query = "INSERT INTO d_a_reservation_valide(dateHeure,id_vol) VALUES (?,?)";
    ...
    public DAReservatioModel getLastId(int id_vol) throws Exception {
        DAReservatioModel dernierRes = null;
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String query = "null";
        ...
        try {
            ...
            query = "SELECT * FROM d_a_reservation_valide WHERE id_vol=? ORDER BY id DESC LIMIT 1";
            ...
            if (rs.next()) {
                ...
                dernierRes = new DAReservatioModel(
                        rs.getInt("id"),
